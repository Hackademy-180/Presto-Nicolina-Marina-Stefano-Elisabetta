...
<<<<<<< HEAD
                ...
                <div class="row justify-content-center">
                    @for ($i = 0; $i < 6; $i++)
                        <div class="col-6 col-md-4 mb-4 text-center">
                            <img src="https://picsum.phostos/300" class="img-fluid rounded shadow" alt="immagine segnaposto">               
                        </div>
                    @endfor
                </div>
            </div>
            <div class="col-4 ps-4 d-flex flex-column justify-content-between">
                <div>
    ...
    @else
        <div class="row justify-content-center aling-items-center height-custom text-center">
            <div class="col-12">
    ...
    <div class="row justify-content-center pt-5">
        ...
        <div class="col-md-4 d-flex flex-column justify-content-between">
            <div>
                ...
                <p class="fs-6">{{ $article_to_check->description }}</p>
            </div>
