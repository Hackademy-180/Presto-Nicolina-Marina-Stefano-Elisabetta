<x-layout>
    ...
    <main class="container-fluid">
        ...
        <section class="container">
            ...
            <div class="row wh-75 justify-content-center mt-1">

                {{-- LEFT SIDE - VANTAGGI --}}
                <article class="col-12 col-md-5 me-5 mt-5 sidebar-register order-2 order-md-1">
                ...
                {{-- RIGHT SIDE - FORM --}}
                <article class="col-12 col-md-5 mt-5 registerSection order-1 order-md-2">
