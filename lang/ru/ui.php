...
return
    [
        ...
        'password' => [
            'forgetted' => 'Забыли пароль?',
        ],
        'recovery' => [
            'password' => 'Восстановить пароль',
        ],

        'editArticle' => 'Редактировать объявление',
        ...
        'mail' => [
            'reset_password' => [
                ...
                'title' => 'Сброс пароля',
                'request_message' => 'Вы запросили сброс пароля для аккаунта Presto.',
                'button' => 'Сбросить пароль',
                'expiry_notice' => 'Ссылка действительна в течение 60 минут.',
                'fallback_text' => 'Если кнопка не работает, скопируйте и вставьте эту ссылку в браузер:',
                'ignore_notice' => 'Если вы не запрашивали сброс пароля, просто проигнорируйте это письмо.',
                'footer' => '© :year Presto. Все права защищены.',
            ],
        ],

        'cvAttached' => 'Резюме прикреплено к этому письму.',
