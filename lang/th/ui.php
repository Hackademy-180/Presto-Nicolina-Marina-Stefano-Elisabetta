...
return
    [
        ...
        'password' => [
            'forgetted' => 'ลืมรหัสผ่าน?',
        ],
        'recovery' => [
            'password' => 'รีเซ็ตรหัสผ่าน',
        ],

        'editArticle' => 'แก้ไขประกาศ',
        ...
        'mail' => [
            'reset_password' => [
                ...
                'request_message' => 'คุณได้ร้องขอรีเซ็ตรหัสผ่านสำหรับบัญชี Presto ของคุณ',
                'button' => 'รีเซ็ตรหัสผ่าน',
                'expiry_notice' => 'ลิงก์นี้จะหมดอายุภายใน 60 นาที',
                'fallback_text' => 'หากปุ่มไม่ทำงาน ให้คัดลอกและวางลิงก์นี้ในเบราว์เซอร์:',
                'ignore_notice' => 'หากคุณไม่ได้ร้องขอรีเซ็ต ให้เพิกเฉยต่ออีเมลนี้',
                'footer' => '© :year Presto สงวนลิขสิทธิ์',
            ],
        ],

        'cvAttached' => 'แนบประวัติย่อ (CV) มาพร้อมกับอีเมลนี้แล้ว',
